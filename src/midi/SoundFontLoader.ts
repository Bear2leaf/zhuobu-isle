...
export default class SoundFontLoader {
	...
	private readonly instrumentNamesArray: string[] = [
	...
	private readonly drumNamesArray: string[] = [];
	private readonly drumKeyArray: string[] = [
		'35_0_Chaos_sf2_file', '35_12_JCLive_sf2_file', '35_16_JCLive_sf2_file', '35_18_JCLive_sf2_file', '35_4_Chaos_sf2_file', '36_0_SBLive_sf2', '36_12_JCLive_sf2_file', '36_16_JCLive_sf2_file', '36_18_JCLive_sf2_file'
	...
	drumTitles(): string[] {
		if (this.drumNamesArray.length == 0) {
			this.drumNamesArray[35] = "Bass Drum 2";
			this.drumNamesArray[36] = "Bass Drum 1";
			this.drumNamesArray[37] = "Side Stick/Rimshot";
			this.drumNamesArray[38] = "Snare Drum 1";
			this.drumNamesArray[39] = "Hand Clap";
			this.drumNamesArray[40] = "Snare Drum 2";
			this.drumNamesArray[41] = "Low Tom 2";
			this.drumNamesArray[42] = "Closed Hi-hat";
			this.drumNamesArray[43] = "Low Tom 1";
			this.drumNamesArray[44] = "Pedal Hi-hat";
			this.drumNamesArray[45] = "Mid Tom 2";
			this.drumNamesArray[46] = "Open Hi-hat";
			this.drumNamesArray[47] = "Mid Tom 1";
			this.drumNamesArray[48] = "High Tom 2";
			this.drumNamesArray[49] = "Crash Cymbal 1";
			this.drumNamesArray[50] = "High Tom 1";
			this.drumNamesArray[51] = "Ride Cymbal 1";
			this.drumNamesArray[52] = "Chinese Cymbal";
			this.drumNamesArray[53] = "Ride Bell";
			this.drumNamesArray[54] = "Tambourine";
			this.drumNamesArray[55] = "Splash Cymbal";
			this.drumNamesArray[56] = "Cowbell";
			this.drumNamesArray[57] = "Crash Cymbal 2";
			this.drumNamesArray[58] = "Vibra Slap";
			this.drumNamesArray[59] = "Ride Cymbal 2";
			this.drumNamesArray[60] = "High Bongo";
			this.drumNamesArray[61] = "Low Bongo";
			this.drumNamesArray[62] = "Mute High Conga";
			this.drumNamesArray[63] = "Open High Conga";
			this.drumNamesArray[64] = "Low Conga";
			this.drumNamesArray[65] = "High Timbale";
			this.drumNamesArray[66] = "Low Timbale";
			this.drumNamesArray[67] = "High Agogo";
			this.drumNamesArray[68] = "Low Agogo";
			this.drumNamesArray[69] = "Cabasa";
			this.drumNamesArray[70] = "Maracas";
			this.drumNamesArray[71] = "Short Whistle";
			this.drumNamesArray[72] = "Long Whistle";
			this.drumNamesArray[73] = "Short Guiro";
			this.drumNamesArray[74] = "Long Guiro";
			this.drumNamesArray[75] = "Claves";
			this.drumNamesArray[76] = "High Wood Block";
			this.drumNamesArray[77] = "Low Wood Block";
			this.drumNamesArray[78] = "Mute Cuica";
			this.drumNamesArray[79] = "Open Cuica";
			this.drumNamesArray[80] = "Mute Triangle";
			this.drumNamesArray[81] = "Open Triangle";
		}
