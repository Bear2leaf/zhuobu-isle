...
export default class Delaunator {
    ...
    private readonly _hullPrev: Uint32Array
    private readonly _hullNext: Uint32Array
    private readonly _hullTri: Uint32Array
    private readonly _hullHash: Int32Array
    private readonly _ids: Uint32Array
    private readonly _dists: Float64Array
    ...
    halfedges: Int32Array = new Int32Array(0);
    trianglesLen = 0;
...
function defaultGetX(p: number[]): number {
    return p[0];
}
function defaultGetY(p: number[]): number {
    return p[1];
}
